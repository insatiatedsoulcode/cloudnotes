...
send_verification_email() uses keyword-only args so mock.call_args.kwargs works
cleanly in tests without positional-index fragility.
"""
...
def send_verification_email(*, to: str, token: str) -> None:
    ...
    msg["Subject"] = "Verify your CloudNotes email address"
    ...
    try:
        ...
        log.info("EMAIL SENT  to=%s  type=verify", to)
    except Exception as exc:
        # Non-fatal: user can resend.  Don't crash registration over an SMTP hiccup.
